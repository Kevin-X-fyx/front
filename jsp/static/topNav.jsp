<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<style>
		.top-brand {
			...
			background-color: rgba(111, 206, 193, 1);
		...
		.top-brand .nav .dropdown-menu.profile::before {
			left: 100%;
			margin-left: -28px;
			border-bottom-color: rgba(111, 206, 193, 0.62);
		}
		...
		.top-brand .nav .dropdown-menu.profile h5 {
			...
			border-style: solid;
			border-color: #333;
			background-color: rgba(111, 206, 193, 0.62);
			box-shadow: 0 0 6px #6FCEC1;
			text-align: center;
		}
		...
		.top-brand .nav .dropdown-menu.profile .web span.ti-power-off {
			...
			border-color: #333;
			background-color: rgba(111, 206, 193, 1);
			box-shadow: 0 0 0px rgba(30, 144, 255, .3);
		}
		...
		.top-brand .nav .dropdown-menu.profile .web:hover{
			...
			border-style: solid;
			border-color: rgba(0,0,0,.3);
			background-color: rgba(111, 206, 193, 0.58);
			box-shadow: 0 0 0px rgba(30, 144, 255, 0);
		}
		...
		.top-brand .nav .dropdown-menu.profile .exit:hover{
			...
			border-style: solid;
			border-color: rgba(0,0,0,.3);
			background-color: rgba(111, 206, 193, 0.56);
			box-shadow: 0 0 6px rgba(30, 144, 255, 0);
		}
				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">流浪动物救助及领养管理系统</a>
						</div>
