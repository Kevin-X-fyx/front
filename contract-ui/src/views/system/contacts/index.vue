...
<script>
import { listContacts, getContacts, delContacts, addContacts, updateContacts } from "@/api/system/contacts";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除通讯录管理编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/contacts/export', {
        ...this.queryParams
